...
torch::Tensor blocksparse_matmul_transpose_cutlass_(torch::Tensor dense_a_t,
                                 torch::Tensor row_ends_b,
                                 torch::Tensor cols_b,
                                 torch::Tensor data_b,
                                 int size_rows_b,
								 ...
								 torch::Tensor dense_out)
{
    return blocksparse_matmul_transpose_cutlass(dense_a_t, row_ends_b, cols_b, data_b, size_rows_b, size_cols_b, block_size_rows_b, block_size_cols_b, dense_out);
}
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  ...
  m.def("blocksparse_matmul_transpose_cutlass", &blocksparse_matmul_transpose_cutlass_, "blocksparse_matmul_transpose_cutlass");
